...
// Enable this if you're not using those shitty binder clips and have been
// blessed with swiss clips or cheap knockoffs
//#define SwissClips
...
// Enable to show the bitmap in Marlin/_Bootscreen.h on startup.
  ...
  #define lerdgeFilSensor
    ...
    #define ABL_BI
  #endif
  #if DISABLED(BedAC) && DISABLED(BedDC)
    #define BedDC
  #endif
#endif
...
#if NONE(MeshFast, MeshStd, MeshFine, MeshBLV, MeshXtraFine, MeshExtreme)
  #define MeshStd
#endif
...
#define CUSTOM_MACHINE_NAME "Ender5Plus"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #else
    #define  DEFAULT_bedKp 131.06
    #define  DEFAULT_bedKi 11.79
    #define  DEFAULT_bedKd 971.23
  #endif
 ...
 */
...
#if ANY(SKR13, SKR14, SKR14Turbo, SKRPRO11, SKRMINIE320, MachineCR10SV2, CrealitySilentBoard, MachineCR10SPro, MachineCR10SProV2, MachineCR10Max) && DISABLED(SKR_UART)
  #if ENABLED(SKR_2209)
    ...
    #endif
  #endif
#elif ANY(SKR13, SKR14, SKR14Turbo, SKRPRO11, SKRMINIE320) && ENABLED(SKR_UART)
  #if ENABLED(SKR_2209)
